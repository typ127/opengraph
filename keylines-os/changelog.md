...
- **BioFabric Tuning Panel**: 
    ...
    - **Erweiterte Sortierung**: Umschalten zwischen `Importance`, `By Type` und neu: `By Activity` (Anzahl Verbindungen).
    - **System Colors Mode**: Einheitliche Primärfärbung für alle vertikalen Relationen.
- **Smart Camera & Stabilität**:
    - Optimierte Bounding-Box für bündiges Zentrieren der vertikalen Kanten-Spalten.
    - Fix für "Left-Drift": Relative Kanten-Positionierung verhindert das Wandern des Gitters beim Knoten-Spawn.
